...
public final class AttributesMap {
        ...
        public AttributesMap() {
            ...
            attributeMap.put("researchworkreport", new ResearchWorkReportAttributes());
            attributeMap.put("отчёт о научной работе кафедры", new ResearchWorkReportAttributes());
            ...
            attributeMap.put("pilpitworkingplan", new PilpitWorkingPlanAttributes());
            attributeMap.put("план работы кафедры", new PilpitWorkingPlanAttributes());
            attributeMap.put("pilpitworkingreport", new PilpitWorkingReportAttributes());
            attributeMap.put("отчёт работы кафедры", new PilpitWorkingReportAttributes());
            ...
            attributeMap.put("advert", new AdvertAttributes());
            attributeMap.put("объявление", new AdvertAttributes());
            ...
            attributeMap.put("заявка на нир", new ResearchWorkRequestAttributes());
            attributeMap.put("researchworkrequest", new ResearchWorkRequestAttributes());
            attributeMap.put("программа конференции", new ConferenceProgramAttributes());
            attributeMap.put("conferenceprogram", new ConferenceProgramAttributes());
            attributeMap.put("сборник тезисов", new ConferenceThesisCollectionAttributes());
            attributeMap.put("conferencethesiscollection", new ConferenceThesisCollectionAttributes());
            attributeMap.put("undefined", new UndefinedAttributes());
            attributeMap.put("не определено", new UndefinedAttributes());
            attributeMap.put("classroomloadjournal", new ClassroomLoadJournalAttributes());
            attributeMap.put("журнал о выполнении аудиторной нагрузкио", new ClassroomLoadJournalAttributes());
        }
