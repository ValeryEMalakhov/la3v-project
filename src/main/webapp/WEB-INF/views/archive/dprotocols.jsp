                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tr>
                                        ...
                                        <th>Срок архивации</th>
                                        <th>Комментарии документа</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach items="${entityDeleteProtocolOutputList}" var="dprotocol">
                                        <tr>
                                            ...
                                            <td><c:out value="${dprotocol.userLastName}"/></td>
                                            <td><c:out value="${dprotocol.documentName}"/></td>
                                            <td><c:out value="${dprotocol.documentAuthor}"/></td>
                                            <td><c:out value="${dprotocol.documentArchivePath}"/></td>
                                            <td><c:out value="${dprotocol.documentDateOfCreation}"/></td>
                                            <td><c:out value="${dprotocol.documentDateOfArchiving}"/></td>
                                            <td><c:out value="${dprotocol.archivingTerm}"/></td>
                                            <td><c:out value="${dprotocol.documentComments}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
