                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/сourseWork" var="formUrl"/>
                                <form:form method="post" modelAttribute="attributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/сourseWork" class="form-horizontal">
