                            ...
                            <div class="x_content">
                                ...
                                <form:form method="post" modelAttribute="attributes"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="approvalYear" type="number" min="1990" max="2017" step="1"  value = "${documentFromSystemAttr.approvalYear}" pattern="199[0-9]|20[0-9][0-9]" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <select class="select2_group form-control" id="studyForm"
