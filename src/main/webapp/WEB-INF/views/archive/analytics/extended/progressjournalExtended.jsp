            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Журналы текущей успеваемости</h3>
                    </div>
                </div>
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach items="${mapDocument}" var="map">
                                        <tr>
                                            ...
                                            <td><c:out value="${map.value.discipline}"/></td>
                                            <td><c:out value="${map.value.specialty}"/></td>
                                            <td><c:out value="${map.value.lecturer}"/></td>
                                            <td><c:out value="${map.value.group}"/></td>
                                            <td><c:out value="${map.value.semester}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
