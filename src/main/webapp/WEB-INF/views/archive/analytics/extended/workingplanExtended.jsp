                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach items="${mapDocument}" var="map">
                                        <tr>
                                            ...
                                            <td><c:out value="${map.value.studyYear}"/></td>
                                            <td><c:out value="${map.value.specialtyName}"/></td>
                                            <td><c:out value="${map.value.level}"/></td>
                                            <td><c:out value="${map.value.studyForm}"/></td>
                                            <td><c:out value="${map.value.pilpitName}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
