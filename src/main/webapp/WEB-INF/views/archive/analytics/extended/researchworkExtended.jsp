                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tr>
                                        ...
                                        <th>План</th>
                                        <th>Планы этапов</th>
                                        <th>Аннотированные отчёты о выполнении этапов НИР</th>
                                        <th>Итоговый очтёт</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach items="${mapDocument}" var="map">
                                        <tr>
                                            ...
                                            <td><c:out value="${map.value.number}"/></td>
                                            <td><c:out value="${map.value.startDate}"/></td>
                                            <td><c:out value="${map.value.endDate}"/></td>
                                            <td><c:out value="${map.value.plan}"/></td>
                                            <td><c:out value="${map.value.stagePlan}"/></td>
                                            <td><c:out value="${map.value.report}"/></td>
                                            <td><c:out value="${map.value.finalReport}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
