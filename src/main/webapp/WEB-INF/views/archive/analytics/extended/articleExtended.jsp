                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach items="${mapDocument}" var="map">
                                        <tr>
                                            ...
                                            <td><c:out value="${map.value.authors}"/></td>
                                            <td><c:out value="${map.value.articleName}"/></td>
                                            <td><c:out value="${map.value.editionName}"/></td>
                                            <td><c:out value="${map.value.year}"/></td>
                                            <td><c:out value="${map.value.editionCategory}"/></td>
                                            <td><c:out value="${map.value.index}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
