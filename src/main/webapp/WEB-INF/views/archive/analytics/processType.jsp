                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <h2>Выберите процесс докуметооборота</h2>
                            <div class="x_title">
                            </div>
                            <div class="x_content">
                                <spring:url value="/archive/analytics/proctype" var="formUrl"/>
                                <form:form method="post" action="/archive/analytics/proctype" class="form-horizontal"
                                    ...
                                    <select class="select2_group form-control" id="optionString"
                                        ...
                                        <option value="educational">Учебный процесс</option>
                                        <option value="scientific">Научный процесс</option>
                                        <option value="organizational">Организационный процесс</option>
                                        <option value="mat_support">МАТ обеспечение</option>
                                    </select>
                                    <br/>
