                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <p><a href=<spring:url value="analytics/doctype"/>/>Выборка документов по типу</p>
                                <p><a href=<spring:url value="analytics/process"/>/>Выборка документов по процессу</p>
                                <p><a href=<spring:url value="analytics/authors"/>/>Выборка документов по автору</p>
                            </div>
                        </div>
                    </div>
                </div>
