            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Удаление документа из архива</h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <spring:url value="/archive/all/delete/${documentId}" var="formUrl"/>
                                <form:form method="post" action="/archive/all/delete/${documentId}" class="form-horizontal">
                                           <%--modelAttribute="documentToArchive"--%>
                                    <h2>Вы действительно хотите удалить файл ${documentName}?</h2>
                                    <br/>
