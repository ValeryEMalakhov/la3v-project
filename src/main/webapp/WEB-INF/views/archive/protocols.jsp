                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach items="${entityProtocolOutputList}" var="protocol">
                                        <tr>
                                            <td><c:out value="${protocol.name}"/></td>
                                            <td><c:out value="${protocol.date}"/></td>
                                            <td><c:out value="${protocol.time}"/></td>
                                            <td><c:out value="${protocol.userLastName}"/></td>
                                            <td><c:out value="${protocol.action}"/></td>
                                            <td><c:out value="${protocol.comments}"/></td>
                                            <td><c:out value="${protocol.documentName}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
