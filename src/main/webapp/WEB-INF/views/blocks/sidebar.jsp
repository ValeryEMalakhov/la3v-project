        ...
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-archive"></i> Архив <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    ...
                    <li><a href="<spring:url value="/archive/analytics/"/>"> Расширенный поиск </a></li>
                </ul>
            </li>
        </ul>
    </div>
        ...
        <%--<ul class="nav side-menu">--%>
            <%--<li><a><i class="fa fa-bug"></i> Кабинет <span class="fa fa-chevron-down"></span></a>--%>
                <%--<ul class="nav child_menu">--%>
                    ...
                    <%--&lt;%&ndash;<li><a href="<spring:url value="/profile/docs"/>"> Личные документы </a></li>&ndash;%&gt;--%>
                <%--</ul>--%>
            <%--</li>--%>
            <%--&lt;%&ndash;                            <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>--%>
                                            <%--<ul class="nav child_menu">--%>
