                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <br/>
                                <security:authorize
                                        access="hasAnyRole('ROLE_lecturer', 'ROLE_admin', 'ROLE_methodologist')">
                                    <b>Вы вошли как:</b> <security:authentication property="principal.username"/>
                                    <br/>
                                    с ролью: <b><security:authentication property="principal.authorities"/> </b>
                                </security:authorize>
                            </div>
                        </div>
                    </div>
