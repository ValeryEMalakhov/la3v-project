                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/lecturerPlan" var="formUrl"/>
                                <form:form method="post" modelAttribute="lecturerPlan"
                                           action="/archive/archivation/{${addressPart}}/attributes/lecturerPlan" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="process" type="text" class="form-control" id="process"
                                                   readonly value="Организационный">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="docType" type="text" class="form-control" id="docType"
                                                   value="Индивидуальный план преподавателя">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="position">Должность:</label>
                                        <div class="col-xs-9">
                                            <input name="position" type="text" class="form-control" id="position"
                                                   readonly value="Преподаватель">
                                        </div>
                                    </div>
