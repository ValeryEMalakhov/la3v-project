                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/monograph"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="monographAttributes"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="editionName">Наименование издания:</label>
                                        <div class="col-xs-9">
                                            <input name="editionName" type="text" class="form-control" id="editionName"
                                                   readonly value="Издание 2">
                                        </div>
                                    </div>
