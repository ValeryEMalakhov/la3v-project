                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/schedule"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="scheduleAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/schedule"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="dayOfWeek">День недели:</label>
                                        <div class="col-xs-9">
                                            <input name="dayOfWeek" type="text" class="form-control" id="dayOfWeek"
                                                   readonly value="Вторник">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="week">Неделя:</label>
                                        <div class="col-xs-9">
                                            <input name="week" type="text" class="form-control" id="week"
                                                   readonly value="6">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="classes">Пара:</label>
                                        <div class="col-xs-9">
