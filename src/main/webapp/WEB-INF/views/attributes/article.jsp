                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/article" var="formUrl"/>
                                <form:form method="post" modelAttribute="articleAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/article" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="articleName" type="text" class="form-control" id="articleName"
                                                   readonly value="Статья 1">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="editionName">Название издательства:</label>
                                        <div class="col-xs-9">
                                            <input name="editionName" type="text" class="form-control" id="editionName"
                                                   readonly value="Название издательства">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="year">Год издания:</label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="editionCategory">Категория издания:</label>
                                        <div class="col-xs-9">
                                            <input name="editionCategory" type="text" class="form-control" id="editionCategory"
                                                   readonly value="Электронное">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="index">Индексируемость:</label>
                                        <div class="col-xs-9">
                                            <input name="index" type="text" class="form-control" id="index"
                                                   readonly value="Индексируемость">
                                        </div>
                                    </div>
