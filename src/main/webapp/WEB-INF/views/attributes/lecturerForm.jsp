                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/lecturerForm" var="formUrl"/>
                                <form:form method="post" modelAttribute="lecturerForm"
                                           action="/archive/archivation/{${addressPart}}/attributes/lecturerForm" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="lecturerName">ФИО преподавателя:</label>
                                        <div class="col-xs-9">
                                            <input name="lecturerName" type="text" class="form-control" id="lecturerName"
                                                   readonly value="Иванов И.И.">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="dateForming">Дата формирования анкеты:</label>
                                        <div class="col-xs-9">
                                            <input name="dateForming" type="text" class="form-control" id="dateForming"
                                                   readonly value="2016-10-12">
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/diploma" var="formUrl"/>
                                <form:form method="post" modelAttribute="diplomaAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/diploma" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="studyYear">Учебный год:</label>
                                        <div class="col-xs-9">
                                            <input name="studyYear" type="text" class="form-control" id="studyYear"
                                                   readonly value="2016-2017">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="supervisor" type="text" class="form-control" id="supervisor"
                                                   readonly value="Малахов Е.В.">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="annotation">Аннотация:</label>
                                        <div class="col-xs-9">
                                    <textarea name="annotation" id="annotation" class="form-control"
                                              rows="6"></textarea>
                                            <style type="text/css">
                                                #annotation {
                                                    resize: none;
