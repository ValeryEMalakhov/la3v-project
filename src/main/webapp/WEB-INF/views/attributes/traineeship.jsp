                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/traineeship"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="traineeshipAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/traineeship"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="dateStart">Дата начала прохождения:</label>
                                        <div class="col-xs-9">
                                            <input name="dateStart" type="text" class="form-control" id="dateStart"
                                                   readonly value="2014-08-17">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="dateEnd">Дата конца прохождения:</label>
                                        <div class="col-xs-9">
                                            <input name="dateEnd" type="text" class="form-control" id="dateEnd"
                                                   readonly value="2015-02-28">
                                        </div>
                                    </div>
