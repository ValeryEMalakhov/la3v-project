                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/сourseWorkAttributes" var="formUrl"/>
                                <form:form method="post" modelAttribute="сourseWorkAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/сourseWorkAttributes" class="form-horizontal">
