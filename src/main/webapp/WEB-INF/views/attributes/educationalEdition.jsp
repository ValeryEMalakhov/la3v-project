                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form method="post" modelAttribute="educationalEditionAttributes"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="type">Тип:</label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="editionName">Издательство:</label>
                                        <div class="col-xs-9">
                                            <input name="editionName" type="text" class="form-control" id="editionName"
                                                   readonly value="Издательство">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="editionType">Вид издания:</label>
                                        <div class="col-xs-9">
                                            <input name="editionType" type="text" class="form-control" id="editionType"
