                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/tutorial"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="tutorialAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/tutorial"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="topic">Тема:</label>
                                        <div class="col-xs-9">
