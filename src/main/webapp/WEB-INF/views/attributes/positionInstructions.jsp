                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/positionInstructions"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="positionInstructionsAttributes"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="author">ФИО преподавателя:</label>
                                        <div class="col-xs-9">
