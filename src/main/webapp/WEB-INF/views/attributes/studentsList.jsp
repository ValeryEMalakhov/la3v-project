                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/studentsList"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="studentsListAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/studentsList"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="docType" type="text" class="form-control" id="docType"
                                                   value="Список фамилий студентов">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="course">Курс:</label>
                                        <div class="col-xs-9">
