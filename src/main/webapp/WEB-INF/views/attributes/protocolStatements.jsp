                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/protocolStatements"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="protocolStatementsAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/protocolStatements"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="data" type="text" class="form-control" id="data"
                                                   readonly value="2015-08-11">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="protocolNumber">Номер протокола:</label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="statementsPurpose">Назначение выписки:</label>
                                        <div class="col-xs-9">
                                            <input name="statementsPurpose" type="text" class="form-control" id="statementsPurpose"
                                                   readonly value="Первая причина это ты">
                                        </div>
                                    </div>
