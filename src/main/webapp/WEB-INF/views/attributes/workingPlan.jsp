                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/workingPlan"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="workingPlanAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/workingPlan"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="studyForm" type="text" class="form-control" id="studyForm"
                                                   readonly value="Заочная">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="pilpitName">Кафедра:</label>
                                        <div class="col-xs-9">
