                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/scientificSeminarProtocol"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="scientificSeminarProtocolAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/scientificSeminarProtocol"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="docType" type="text" class="form-control" id="docType"
                                                   value="Протокол научного семинара">
                                        </div>
                                    </div>
