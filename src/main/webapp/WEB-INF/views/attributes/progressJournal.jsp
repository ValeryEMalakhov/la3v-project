                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/archive/archivation/${addressPart}/attributes/progressJournal"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="progressJournalAttributes"
                                           action="/archive/archivation/{${addressPart}}/attributes/progressJournal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="docType" type="text" class="form-control" id="docType"
                                                   value="Журнал текущей успеваемости">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="discipline">Дисциплина:</label>
                                        <div class="col-xs-9">
                                            <input name="discipline" type="text" class="form-control" id="discipline"
                                                   readonly value="Дисциплина 1">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="specialty">Специальность:</label>
                                        <div class="col-xs-9">
                                            <input name="specialty" type="text" class="form-control" id="specialty"
                                                   readonly value="Специальность 2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="group">Группа:</label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="semester">Семестр:</label>
                                        <div class="col-xs-9">
