                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/document/edit/${addressPart}/attributes/article" var="formUrl"/>
                                <form:form method="post" modelAttribute="attributes"
                                           action="/document/edit/{${addressPart}}/attributes/article" class="form-horizontal">

                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="articleName">Название статьи: <span class="required">*</span></label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="editionCategory">Категория издания: <span class="required">*</span></label>
                                        <div class="col-xs-9">
                                            <select class="select2_group form-control" id="editionCategory"
                                                    name="editionCategory" required>
