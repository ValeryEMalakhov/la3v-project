                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <spring:url value="/document/edit/${addressPart}/attributes/diploma"
                                            var="formUrl"/>
                                <form:form method="post" modelAttribute="attributes"
                                           action="/document/edit/{${addressPart}}/attributes/diploma"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-3" for="studyYear">Учебный год: <span
